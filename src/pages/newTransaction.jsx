...
// For date pickers in the search bar (if you choose to use MUI date pickers)
...
const { TabPane } = Tabs; // Using Tabs.TabPane instead of a separate Item

// ==================================================================
// Table Header (for sorting and selection)
// ==================================================================
...
// ==================================================================
// Table Toolbar (for actions: add, edit, delete, new transaction modal)
// ==================================================================

function EnhancedTableToolbar(props) {
  // Destructure props including selected IDs and a setter to clear selections
  ...
  // State for new transaction modal & forms for each transaction type
  ...
  const onUpdate = (values) => {
    ...
    setOpenEdit(false);
    // TODO: Update the transaction document in Firestore
  };

  // Called after a transaction is created successfully
  const onCreate = (data) => {
  ...
  // Handle submission of the new transaction modal
  ...
  // Show a confirmation modal for deleting selected transaction(s)
  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        <>
          {/* Disable edit unless exactly one row is selected */}
          <Tooltip title="Edit">
            <span>
              <IconButton
...
// ==================================================================
// Transactions Page (main component)
// ==================================================================
...
export default function NewTransactionsPage() {
  ...
  // Sort transactions by the selected order and property
